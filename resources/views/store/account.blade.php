...
@section('content')
<div class="content">
  <h2 class="content-heading pt-10">Account <small>Manage</small></h2>
  @if($errors->any())
...
<div class="modal fade" id="tambahModal" tabindex="-1" role="dialog" aria-labelledby="tambahModal" aria-hidden="true">
  <div class="modal-dialog modal-dialog-popout" role="document">
    <div class="modal-content">
      <div class="block block-themed block-transparent mb-0">
        <div class="block-header bg-primary p-10">
          <h3 class="block-title"><i class="fa fa-plus"></i> Add Account</h3>
          <div class="block-options">
            <button type="button" class="btn-block-option" data-dismiss="modal" aria-label="Close">
              <i class="si si-close"></i>
            </button>
      ...
      <form action="{{ route('account.add') }}" method="post">
        ...
        <div class="block-content">
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="name" placeholder="Add new account" required>
          </div>
          <div class="form-group">
            <label>Channel</label>
            <select class="js-select2 form-control" style="width: 100%" name="channel" required>
        ...
        <div class="modal-content">
            <div class="block block-themed block-transparent mb-0">
                <div class="block-header bg-primary">
                    <h3 class="block-title"><i class="fa fa-edit"></i> Update Account</h3>
                    <div class="block-options">
                        <button type="button" class="btn-block-option" data-dismiss="modal" aria-label="Close">
                            <i class="si si-close"></i>
                        </button>
            ...
            <form id="editForm" method="post">
                ...
                <div class="block-content">
                  ...
                  <div class="row">
                    <div class="form-group col-md-12">
                      <label>Channel</label>
                       <select class="js-edit form-control" id="channelInput" style="width: 100%" name="channel" >
                          @foreach($channel as $data)
                              <option value="{{ $data->id }}">{{ $data->name }}</option>
                          @endforeach
                        </select>
