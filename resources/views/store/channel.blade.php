...
<div class="content">
    ...
    @endif
    <h2 class="content-heading pt-10">Channel <small>Manage</small></h2>
        ...
        <div class="modal-content">
            <div class="block block-themed block-transparent mb-0">
                <div class="block-header bg-primary p-10">
                    <h3 class="block-title"><i class="fa fa-plus"></i> Add Channel</h3>
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-popout" role="document">
        <div class="modal-content">
            <div class="block block-themed block-transparent mb-0">
                <div class="block-header bg-primary p-10">
                    <h3 class="block-title"><i class="fa fa-edit"></i> Update Channel</h3>
                    <div class="block-options">
                        <button type="button" class="btn-block-option" data-dismiss="modal" aria-label="Close">
                            <i class="si si-close"></i>
                        </button>
...
@section('script')
  ...
  <script type="text/javascript">
    function editModal(id,name) {
                ...
                $('#editForm').attr('action', "{{ url('/store/channel/update') }}/"+id);
                $('#nameInput').val(name);
            }
    @if(session('type'))
