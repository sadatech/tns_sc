@extends('layouts.app')
@section('title', "Report Documentation DC")
@section('content')
<div class="content">
  <h2 class="content-heading pt-10">Documentation DC <small>Report</small></h2>
  @if($errors->any())
      ...
      <div class="block-content block-content-full">
        <form method="post" id="filter">
          <div class="row">
            <div class="col-md-4">
              <label>Periode:</label>
              <input class="js-datepicker form-control" type="text" value="{{ Carbon\Carbon::now()->format('m/Y') }}" placeholder="Select Periode" name="periode" data-month-highlight="true" required>
            </div>
            <div class="col-md-4">
              <label>Area:</label>
...
<script type="text/javascript">
 $('#reset').click(function(){
    ...
    setTimeout(function() {
      $('#filterEmployee,#typeFilter,#filterArea').val(null).trigger('change');
    }, 10);
  });
  ...
  $("#btnDownloadXLS").on("click", function(){
      var url= "{{ route('dc.documentation.export') }}"+"?periode="+$(".js-datepicker").val()+"&employee="+$("#filterEmployee").val()+"&type="+$("#typeFilter").val()+"&area="+$("#filterArea").val();
  ...
  $('#filter').submit(function(e) {
    ...
    e.preventDefault();
    var table = null;
    var url = '{!! route('dc.documentation.data') !!}';
