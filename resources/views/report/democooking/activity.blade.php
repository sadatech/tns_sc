      ...
      <div class="block-content block-content-full">
        <div class="block-header p-0 mb-20">
          ...
          <div class="block-option">
              <a href="{{ route('dc.documentation.export') }}" title="Unduh Data" class="btn btn-success btn-square float-right ml-10"><i class="si si-cloud-download mr-2"></i>Unduh Data</a>
          </div>
        </div>
