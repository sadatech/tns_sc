...
@section('content')
<div class="content">
  <h2 class="content-heading pt-10">Kunjungan Demo Cooking <small>Report</small></h2>
  @if($errors->any())
...
$('#filterEmployee').select2(setOptions('{{ route("employee-select2") }}', 'Choose your Employee', function (params) {
  ...
  $("#btnDownloadXLS").on("click", function(){
      var url= "{{ route('dc.kunjungan.export') }}"+"?periode="+$(".js-datepicker").val()+"&employee="+$("#filterEmployee").val()+"&area="+$("#filterArea").val();
  ...
  $('#filter').submit(function(e) {
    ...
    e.preventDefault();
    var table = null;
    var url = '{!! route('dc.kunjungan.data') !!}';
