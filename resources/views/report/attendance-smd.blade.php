@extends('layouts.app')
@section('title', "Report VDO Pasar")
@section('content')
<div class="content">
  <h2 class="content-heading pt-10">VDO Pasar <small>Report</small></h2>
  @if($errors->any())
...
<script type="text/javascript">
  ...
  $("#btnDownloadXLS").on("click", function(){
      var url= "{{ route('export.attendance.smd.pasar') }}"+"?periode="+$(".js-datepicker").val()+"&date="+$("#filterDate").val()+"&employee="+$("#filterEmployee").val()+"&pasar="+$("#filterPasar").val()+"&area="+$("#filterArea").val();
  ...
  $('#filter').submit(function(e) {
    ...
    e.preventDefault();
    var table = null;
    var url = '{!! route('data.attendance.smd.pasar') !!}';
