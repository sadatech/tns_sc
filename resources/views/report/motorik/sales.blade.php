  ...
  <div class="block block-themed" id="table-block" style="display: none"> 
    ...
    <div class="block">        
      ...
      <div class="block-header p-0 mb-20">
        ...
        <table class="table table-striped table-vcenter js-dataTable-full table-hover table-bordered table-responsive" id="onTargetTable">
          <thead>
            <tr>
    ...
    table = $('#onTargetTable').DataTable({
      ...
      ajax: {
        ...
        dataSrc: function(res) {
          ...
          if (res.data == 0) {
            $('#table-block').hide();
            swal("Warning!", "Data is empty!", "error");
            return res.data;
          } else {
            $('#table-block').show();
            return res.data;
