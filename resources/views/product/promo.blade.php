@extends('layouts.app')
@section('title', "Promo Product")
@section('content')
<div class="content">
  <h2 class="content-heading pt-10"> Promo <small>Manage</small></h2>
  @if($errors->any())
        ...
        <div class="modal-content">
            <div class="block block-themed block-transparent mb-0">
                <div class="block-header bg-primary p-10">
                    <h3 class="block-title"><i class="fa fa-edit"></i> Update Product Promo</h3>
              ...
              <div class="block-content">
                ...
                <div class="row">
                  <div class="form-group col-md-6">
                      <label>Area</label>
                      <select class="js-edit form-control" style="width: 100%" id="areaInput" name="area" >
                        @foreach($area as $data)
                          <option value="{{ $data->id }}">{{ $data->region->name }} - {{ $data->name }} </option>
                        @endforeach
                      </select>
                  </div>
                  <div class="form-group col-md-6">
...
<div class="modal fade" id="tambahModal" tabindex="-1" role="dialog" aria-labelledby="tambahModal" aria-hidden="true">
  <div class="modal-dialog modal-dialog-popout modal-lg" role="document">
    <div class="modal-content">
      <div class="block block-themed block-transparent mb-0">
        <div class="block-header bg-primary p-10">
          <h3 class="block-title"><i class="fa fa-plus"></i> Add Promo</h3>
          <div class="block-options">
            <button type="button" class="btn-block-option" data-dismiss="modal" aria-label="Close">
              <i class="si si-close"></i>
            </button>
      ...
      <form action="{{ route('promo.add') }}" method="post">
        ...
        <div class="block-content">
          ...
          <div class="row">
            <div class="form-group col-md-6">
                <label>Area</label>
                <select class="js-select2 form-control" style="width: 100%" name="area" required>
            ...
            <div class="form-group col-md-6">
                <label>Date From</label>
                <input class="js-datepicker form-control" type="date" name="from" data-week-start="1" data-autoclose="true" data-today-highlight="true" data-date-format="yyyy-mm-dd" placeholder="yyyy-mm-dd" required>
            </div>
            <div class="form-group col-md-6">
                <label>Date Until</label>
                <input class="js-datepicker form-control" type="date" name="to" data-week-start="1" data-autoclose="true" data-today-highlight="true" data-date-format="yyyy-mm-dd" placeholder="yyyy-mm-dd" required>
            </div>
        </div>
        <div class="modal-footer">
          <button type="submit" class="btn btn-alt-success">
...
@section('script')
  ...
  <script type="text/javascript">
      function editModal(json) {
          ...
          $('#editForm').attr('action', "{{ url('/product/promo/update') }}/"+json.id);
