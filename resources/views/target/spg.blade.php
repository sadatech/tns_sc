@extends('layouts.app')
@section('title', "SPG Target")
@section('content')
<div class="content">
  <h2 class="content-heading pt-10"> Target<small class="ml-2">SPG Pasar</small></h2>
  @if($errors->any())
...
<div class="modal fade" id="tambahModal" role="dialog" aria-labelledby="tambahModal" aria-hidden="true">
  <div class="modal-dialog modal-dialog-popout modal-lg" role="document">
    <div class="modal-content">
      ...
      <form action="{{ route('target.spg.add') }}" method="post">
        {!! csrf_field() !!}
        <div class="block-content">
          <div class="form-group">
            <label>Employee</label>
...
<script type="text/javascript">
  function editModal(json) {
    ...
    $('#editForm').attr('action', "{{ url('/target/spg/update') }}/"+json.id);
